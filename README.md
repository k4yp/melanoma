...
model predicted most images in a binary fashion with most samples either being 100% or 0% melanoma
(Figure 3). Though some images were predicted incorrectly (Figure 4). The model did surpass the
